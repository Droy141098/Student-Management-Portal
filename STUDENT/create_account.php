        ...
        <button type="button" style="margin-left:70%" class="btn btn-success" id="goBack" onclick="go()">Go Back</button>
         ...
         <form name="myForm" action="create_account.php"  method="post" id="myForm" enctype="multipart/form-data">
            ...
            <div >
                        ...
                        <input type="text" name="firstName" id="firstName" class="form-control" placeholder="Please provide First name." required="true">

            </div>
            <div >
                        <label for="lname">Last name:</label>
                        <input type="text" name="lastName" id="lastName" class="form-control" placeholder="Please provide a last name." required="true">

            </div>
            <div >
                        <label for="email">email:</label>
                        <input type="text" name="email" id="email" class="form-control" placeholder="Please provide email." required="true">

            </div>
            <div >
                        <label for="phnNo">Phone Number:</label>
                        <input type="text" name="phnNo" id="phnNo" class="form-control" placeholder="Please provide phone number." required="true">
            ...
            <div >
                        ...
                        <input type="text" name="address" id="address" class="form-control" placeholder="Please provide address." required="true">
            ...
            <div >
                        ...
                        <small>(min length: 8 ,It should contain one capital letter and one number.)</small>
                        <input type="password" name="pwd" id="pwd" class="form-control" placeholder="Please provide a password." required="true">

            </div>
            
            <div >
                        <label for="confirmPwd">Confirm Password:</label>
                        <input type="password" name="confirmPwd" id="confirmPwd" class="form-control" placeholder="Please provide a password." required="true">
                    ...
                    { 
                     ...
                     if(preg_match("/.+$/",$_POST['address']))
                        ...
                        if($flag==1)
                        {
                            ...
                            ?>
                            <script>
                               alert("Successfully Registered! Your UserID is <?php echo $userid ?>");
